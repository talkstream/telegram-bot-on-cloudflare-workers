...
- **Без AI функций** - Отключены для экономии времени обработки
...
- **AI интеграция** - Gemini API с умными повторами
- **Параллельная обработка** - Конкурентные проверки и операции
...
```bash
# Укажите ваш тарифный план Cloudflare Workers в .dev.vars или wrangler.toml
