  ...
  configs: {
    ...
    strict: {
      ...
      rules: {
        ...
        'db-mapping/require-boolean-conversion': ['error', {
          booleanPrefixes: ['is_', 'has_', 'can_', 'should_', 'will_', 'did_', 'was_', 'are_', 'does_', 'do_'],
          booleanSuffixes: ['_enabled', '_disabled', '_active', '_inactive', '_visible', '_hidden', '_required', '_optional'],
        }],
        'db-mapping/require-date-conversion': ['error', {
          dateFieldPatterns: ['*_at', '*_date', '*_time', 'timestamp*', 'date_*', 'time_*', 'expires_*', 'started_*', 'ended_*'],
          allowNullChecks: true,
        }],
        'db-mapping/use-field-mapper': ['error', {
          minimumFields: 2,
        }],
      },
    },
